...
public class UploadLongAQ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.upload_long_aq);
       ...
       //-----------------Finding Layouts----------------------------
        mToolBar = findViewById(R.id.LongAQ_upload_toolbar);
        Question = findViewById(R.id.InputLongAQQuestion);
        Answer = findViewById(R.id.InputLongAQAnswer);
        Clear = findViewById(R.id.LAQclearBtn);
        Upload = findViewById(R.id.LAQuploadBtn);
        ...
        getSupportActionBar().setTitle("UPLOAD Long AQ");
            ...
            Upload.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!question.equals("") && !answer.equals("")){
                        ...
                        Toast.makeText(UploadLongAQ.this, "All input is mandatory", Toast.LENGTH_SHORT).show();
                        pd.hide();
                    }
                }
            });
        }else {
            Toast.makeText(UploadLongAQ.this, "Unable to Identify you", Toast.LENGTH_SHORT).show();
            pd.hide();
        }
        Clear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                clearField(Question,Answer);
                Toast.makeText(UploadLongAQ.this, "Clear Successful", Toast.LENGTH_SHORT).show();
                pd.dismiss();
            }
        });
    }
        ...
        dataBase.child(timeStamp).setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(UploadLongAQ.this, "Uploaded Successfully you can add another Question", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void sendToStart() {
        Intent gotoSignIn = new Intent(UploadLongAQ.this, Start.class);
